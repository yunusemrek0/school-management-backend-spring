...
public class ErrorMessages {
  ...
  public static final String NOT_HAVE_EXPECTED_ROLE_USER = "Error: User does not have match";
  ...
  public static final String ALREADY_CREATED_LESSON_MESSAGE = "Error: %s Lesson already exists.";
